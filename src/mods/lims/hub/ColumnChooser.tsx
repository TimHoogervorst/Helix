...
export const COMMON_COLUMNS: HubColumn[] = [
  ...
  { key: "project", label: "Project", source: "common", hideable: true, sortable: true, type: "project", icon: null, filterable: false, width: null },
  { key: "folder", label: "Folder", source: "common", hideable: true, sortable: false, type: "folder", icon: null, filterable: false, width: null },
