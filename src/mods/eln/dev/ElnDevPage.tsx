...
export const TABLE_KIT_CAPABILITIES: readonly TableCapability[] = [
  ...
  { id: "selection", label: "Active-cell and range selection", currentOwner: "useTableInteraction", targetOwner: "Table Kit", consumers: ["Registry", "Plain", "Result"], testSeam: "Selection tests", migration: "Kit extraction", coverage: { registry: "Yes", plain: "Yes", kit: "Target", result: "Target" } },
